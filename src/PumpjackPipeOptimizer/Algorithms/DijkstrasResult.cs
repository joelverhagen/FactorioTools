...
{
    public DijkstrasResult(Dictionary<Location, double> locationToCost, Dictionary<Location, HashSet<Location>> locationToPrevious, HashSet<Location> reachedGoals)
    {
