...
System.namespace("Knapcode.FactorioTools.OilField", function (namespace)
  namespace.class("OilFieldOptions", function (namespace)
    ...
    __ctor__ = function (this)
      this.PipeStrategies = KnapcodeFactorioTools.CollectionExtensions.ToTableArray(DefaultPipeStrategies, System.Int32)
      this.BeaconStrategies = KnapcodeFactorioTools.CollectionExtensions.ToTableArray(DefaultBeaconStrategies, System.Int32)
