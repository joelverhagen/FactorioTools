...
/// <param name="Summary">A summary of different oil field plans attempted and their performance.</param>
public record OilFieldPlanResponse(
    OilFieldPlanRequestResponse Request,
    string Blueprint,
    OilFieldPlanSummary Summary);
